...
const Help: React.FC<Props> = () => {
  const { loadingMore, allLoaded, onLoadMore, data, onRefresh, refreshing } =
    useRefreshService<DataType>(fetchData, {
      defaultParams: [{ page: 1, pageSize: 10 }],
    });
  const renderItem = ({ item }: { item: DataType }) => {
    return (
      <Box height={item.height} overflow={'hidden'} margin="1">
